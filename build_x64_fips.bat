...
cd ..\openssl-1.0.2n
rmdir /S/Q tmp32dll
perl Configure VC-WIN64A fips --openssldir=E:\openssl\out_x64_fips threads no-ssl2 no-ssl3 no-idea no-mdc2 no-rc5 no-ec2m no-asm --with-fipsdir=E:\openssl\openssl-fips-ecp-2.0.16
